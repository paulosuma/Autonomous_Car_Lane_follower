...
class LidarProcessing:
    ...
    def construct_birds_eye_view(self, data):
        ...
        # Getting sensor reading for left front       
        filter_front_left = np.logical_and((x_points>-0.1), (x_points<0.1))
        ...
        # Getting sensor reading for right front       
        filter_front_right = np.logical_and((x_points>-0.1), (x_points<0.1))
        ...
        filter_rear_left = np.logical_and((x_points>-0.1), (x_points<0.1))
        ...
        # Getting sensor reading for rear front       
        filter_rear_right = np.logical_and((x_points>-0.1), (x_points<0.1))
